...
export default function BME4910ProjectPage() {
  const images = useMemo(
    () => [
      {
        src: "/projects/bme4910/slide1.png",
        alt: "Figure 1",
        caption: "Figure 1. Recording overview.",
      },
      {
         src: "/projects/bme4910/slide2.png",
         alt: "Figure 2",
    ...
    <div className="grid grid-cols-3 gap-16">
      <div className="col-span-2">
        <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50">
          Large-scale, high-complexity cyborg tissues based on bioelectronic scaffolds and artificial vascular networks
        </h1>
